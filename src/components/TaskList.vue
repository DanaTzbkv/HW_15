import TaskItem from './TaskItem.vue'; import TaskForm from './TaskForm.vue';
<template>
  <div class="task-list">
    <h2>Список задач</h2>
    <div class="task-summary">
      <p>Общее количество задач: {{ totalTasks }}</p>
      <p>Количество выполненных: {{ completedTasks }}</p>
    </div>
    ...
    <ul class="task-items">
      <li
        v-for="task in tasks"
        :key="task.id"
        :class="['task-item', { completed: task.completed, 'not-completed': !task.completed }]"
      >
      ...
      tasks: [
        {
          ...
          description: 'Купить шоколад, но только не белый',
          completed: false
        },
        {
          id: 2,
          title: 'Купить хлеб',
          description: 'Купить хлеб, но только не белый',
          completed: false
        },
        {
          id: 3,
          title: 'Купить йогурт',
          description: 'Купить йогурт, но только не клубничный',
          completed: false
        }
      ]
    }
